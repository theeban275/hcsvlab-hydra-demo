...
class CatalogController < ApplicationController  
  ...
  configure_blacklight do |config|
    config.default_solr_params = { 
      :qf => "corpus_name_tesim sub_corpus_name_tesim year_tesim media_type_tesim title_tesim",
      :qt => 'search',
      :rows => 10 
    }
    ...
    config.add_facet_field solr_name('corpus_name', :facetable), :label => 'Name'  
    config.add_facet_field solr_name('sub_corpus_name', :facetable), :label => 'Sub Corpus Name'  
    config.add_facet_field solr_name('year', :facetable), :label => 'Year'  
    config.add_facet_field solr_name('media_type', :facetable), :label => 'Media Type' 
    ...
    config.add_index_field solr_name('media_type', :stored_searchable, type: :string), :label => 'Media Type:'
    config.add_index_field solr_name('url', :displayable, type: :string), :label => 'URL:'
    ...
    config.add_show_field solr_name('media_type', :stored_searchable, type: :string), :label => 'Media Type:'
    ...
    #   #field.solr_parameters = { :'spellcheck.dictionary' => 'media type' }
    #   field.qt = 'search'
    #   field.solr_local_parameters = { 
    #     :qf => '$media_type_qf',
    #     :pf => '$media_type_pf'
